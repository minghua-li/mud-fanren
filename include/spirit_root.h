...
//
// 本文件合并 #26（基础框架）与 #27（成长与突破）两套常量体系：
//   1. #27 新体系：SPIRIT_ROOT_NONE~HEAVENLY 枚举（0=最差, 5=最佳）
//   2. #26 向后兼容：ROOT_T0~T5 旧命名（0=最佳, 5=最差）
...
//=============================================================================
// #26 向后兼容常量（旧 ROOT_T0~T5 体系，与 SPIRIT_ROOT_* 枚举值不同）
// ROOT_QUALITY_T0=0 代表 天灵根（最佳），ROOT_QUALITY_T5=5 代表 无灵根（最差）
// SPIRIT_ROOT_NONE=0 相反，注意区分使用场景
//=============================================================================
...
// 灵根品质索引（T0=0 最佳 → T5=5 最差）
// 注意与 SPIRIT_ROOT_* 枚举相反：SPIRIT_ROOT_NONE=0 对应 ROOT_QUALITY_T5
...
// 变异灵根子类型
#define ROOT_VAR_THUNDER    "雷"
#define ROOT_VAR_ICE        "冰"
#define ROOT_VAR_WIND       "风"
#define ROOT_VAR_DARK       "暗"
...
// 灵根生成概率（千分比，以有灵根者为分母）
#define ROOT_PROB_T0        2
#define ROOT_PROB_T1        8
#define ROOT_PROB_T2        150
#define ROOT_PROB_T3        200
#define ROOT_PROB_T4        640

// 基础属性加点
#define INIT_ATTR_POINTS    80
#define INIT_ATTR_BASE      10
#define INIT_ATTR_MAX       30

// 灵根在 dbase 中的存储路径
#define SPIRIT_ROOT_DATA    "spirit_root"

// 灵根存储 mapping 的 key（#26 旧风格，与 ROOT_PROP_* 共存）
#define SR_QUALITY          "quality"
#define SR_QUALITY_IDX      "quality_idx"
#define SR_ELEMENTS         "elements"
#define SR_VARIANT          "variant"
#define SR_STRENGTH         "strength"
#define SR_PURITY           "purity"
#define SR_MAIN_ELEMENT     "main_element"
